...
Soft delete, ורק אם המשתמש חבר ב-workspace</a>
                                ...
                                <a href="#endpoints-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId-">DELETE api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
                                <a href="#endpoints-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">List comments for a task.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
                                <a href="#endpoints-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">Store a new comment for the task.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
                                <a href="#endpoints-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">Update an existing comment.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
                                <a href="#endpoints-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">Delete comment.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:57 GMT; Max-Age=7200; path=/; httponly; samesite=lax
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:57 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:57 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:58 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:58 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">List comments for a task.</h2>
...
<span id="example-requests-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/workspaces/consequatur/projects/consequatur/tasks/consequatur/comments" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/workspaces/consequatur/projects/consequatur/tasks/consequatur/comments"
);
...
<span id="example-responses-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
content-type: application/json
vary: Origin
set-cookie: laravel_session=%3D; expires=Wed, 04 Mar 2026 20:12:58 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
<span id="execution-results-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" data-method="GET"
      data-path="api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    onclick="tryItOut('GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    onclick="cancelTryOut('GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="workspaceId"                data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="projectId"                data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="taskId"                data-endpoint="GETapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">Store a new comment for the task.</h2>
...
<span id="example-requests-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">
</span>
<span id="execution-results-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments" data-method="POST"
      data-path="api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    onclick="tryItOut('POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    onclick="cancelTryOut('POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="workspaceId"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="projectId"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="taskId"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="POSTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must be at least 1 character. Must not be greater than 2000 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">Update an existing comment.</h2>
...
<span id="example-requests-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/v1/workspaces/consequatur/projects/consequatur/tasks/consequatur/comments/consequatur" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
</span>
<span id="execution-results-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" data-method="PUT"
      data-path="api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments/{commentId}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    onclick="tryItOut('PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    onclick="cancelTryOut('PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments/{commentId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="workspaceId"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="projectId"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="taskId"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="commentId"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="PUTapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must be at least 1 character. Must not be greater than 2000 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">Delete comment.</h2>
...
<span id="example-requests-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">
</span>
<span id="execution-results-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-" data-method="DELETE"
      data-path="api/v1/workspaces/{workspaceId}/projects/{projectId}/tasks/{taskId}/comments/{commentId}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    onclick="tryItOut('DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    onclick="cancelTryOut('DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="workspaceId"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="projectId"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="taskId"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="commentId"                data-endpoint="DELETEapi-v1-workspaces--workspaceId--projects--projectId--tasks--taskId--comments--commentId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
