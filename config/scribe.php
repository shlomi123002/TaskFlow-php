...
return [
    ...
    'auth' => [
        ...
        // כשזה Bearer, הכותרת היא Authorization
        'name' => 'Authorization',

        // הטוקן ש-Scribe ישתמש בו כשמבצע response calls (לא מוצג בדוקס)
        'use_value' => env('SCRIBE_AUTH_KEY'),

        // מה שהמשתמש יראה כדוגמה
        'placeholder' => 'Bearer {YOUR_TOKEN}',

        'extra_info' => 'Get a token from POST /api/v1/login and send it as: Authorization: Bearer <token>.',
    ],
